...
const DEFAULT_TASK_CLASS_MAPPING: Record<NonNullable<StageTaskClassInput["taskClass"]>, Stage> = {
	architecture: "plan",
	ambiguous: "plan",
 ...
 */
export function classifyStage(input: ShiftInput, config: StageConfig = {}): Stage {
