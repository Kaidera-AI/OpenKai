...
import { cortexManaged, cortexRecordTool, cortexSearchTool } from "./cortex-memory.js";
import { fusionTool } from "./fusion-tool.js";
import { rlmCollect, rlmSpawn } from "./rlm-tools.js";
...
export function openkaiBuiltinTools(): CustomTool[] {
	...
	if (cortexManaged())
		tools.push(cortexSearchTool as unknown as CustomTool, cortexRecordTool as unknown as CustomTool);
	return tools;
}
