...
export const BUILD_CHANNEL: Channel =
  typeof OPENKAI_BUILD_CHANNEL !== "undefined" && OPENKAI_BUILD_CHANNEL === "standalone"
    ? "standalone"
    : "npm";
...
export const DEFAULT_MANIFEST_URL =
  "https://github.com/Kaidera-AI/OpenKai/releases/latest/download/latest.json";
...
export class Upgrader {
  ...
  async check(): Promise<CheckResult> {
    ...
    const updateAvailable =
      artifact !== undefined && compareVersions(manifest.version, this.opts.currentVersion) > 0;
