...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "",
      "Magic keywords (standalone prose, shimmer in the composer):",
      "  ultrathink <prompt>  the fusion panel thinks it through — models combined",
      "  ultrareview <ctx>    multi-model adversarial review of the current diff",
      "  Toggle: /settings → interaction → magic keywords",
    ],
    seeAlso: ["providers"],
  },
  {
