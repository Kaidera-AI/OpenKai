...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "name", description: "Name this session (shown in /sessions, /resume search, exports).", argumentHint: "<display-name>" },
...
export function helpText(): string[] {
  return [
    ...
    "  /name <text>     name this session (shown in /sessions + /resume search)",
