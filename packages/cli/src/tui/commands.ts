...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "shake", description: "Strip heavy tool results from context; /shake thinking also strips reasoning blocks.", argumentHint: "[thinking]" },
...
export function helpText(): string[] {
  return [
    ...
    "  /shake [thinking] strip heavy tool results (and reasoning blocks) to reclaim tokens",
