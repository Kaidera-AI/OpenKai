...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "fork", description: "Fork this session into a new branch; prints a paste-able resume receipt." },
  ...
  { name: "logout", description: "Sign out of an OAuth provider.", argumentHint: "<provider>" },
...
export function helpText(): string[] {
  return [
    ...
    "  /fork            branch this session (prints a resume receipt)",
    ...
    "  /context         token usage for this session",
    "  /features [key]  list / toggle optional features (all on by default)",
    "  /theme           toggle dark/light theme",
    "  /autonomy [lvl]  cycle the autonomy axis: off/low/med/high",
