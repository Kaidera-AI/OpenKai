...
# Prefer the explicitly configured runtime. Auto mode follows the supported
# production matrix: rootless Podman first on Linux, Docker on macOS. Apple
# Container remains explicit until its non-Compose adapter passes the spare-Mac
# POC; merely installing its CLI must not switch a live deployment.
# ---------------------------------------------------------------------------
